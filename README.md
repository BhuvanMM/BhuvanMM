...
const bhuvan = {
  ...
  code: ["JavaScript", "C++", "C", "HTML5", "CSS3"],
  technologies: {
    frontend: ["React", "Tailwind CSS", "Responsive Design"],
    backend: ["Node.js", "Express.js", "RESTful APIs"],
    databases: ["MongoDB", "PostgreSQL", "Redis"],
    infrastructure: ["Git", "Linux", "Firebase", "Apache Kafka"],
...
## <img src="https://media.giphy.com/media/iY8CRBdQXODJSCERIr/giphy.gif" width="30"> Technology Stack
...
![Tailwind](https://img.shields.io/badge/Tailwind_CSS-000000?style=for-the-badge&logo=tailwind-css&logoColor=06B6D4)
...
![Kafka](https://img.shields.io/badge/Apache_Kafka-000000?style=for-the-badge&logo=apache-kafka&logoColor=FF0000)
